...
\section{Die Webseite und deren wichtigsten Applikationen}
Die Webseite der Wetterstation ist mit dem CMS Openfile64Light der Firma Screenbox erstellt. Mit diesem ist es möglich um mit ein paar Klicks eine Webseite erstellt werden kann. Es kann direkt in einem Browser der gewollte Text sowie Bilder und Graphiken eingesetzt werden. Des Weiteren können auch Formulare, Menüs und Applikationen einfach mit einem Mausklick eingesetzt werden.Screenbox bietet hierfür zwei Versionen des CMS an, openfile64Light und openfile64? Dabei enthält die Light Version des CMS folgende Funktionen nicht:
\begin{itemize}
