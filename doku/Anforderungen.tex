...
\begin{usecase}
  ...
  \addrow{Anforderung}{Die Wetterstation Arbon verfügt über eine öffentlich nutzbar Schnittstelle (API) für Luft- und Wassertemperatur, sodass z.B. das Seebad diese übernehmen kann.}
  \addrow{Wichtigkeit}{MUSS}
