...
% 
\begin{usecase}
  \addheading{UI 060}{Sample-Rate} 
  \addrow{Anforderung}{Die Sample-Rate der Graphen ist kleiner gleich zehn Minuten auf der Wassersport-Seite und kleiner gleich eine Stunde auf der Tourismus-Seite. Der Graph auf der Wassersport-Seite zeigt die letzten 24h, der Graph auf der Tourismus-Seite die letzten sieben Tage.}
  \addrow{Wichtigkeit}{SOLL}
...
\begin{usecase}
  ...
  \addrow{Wichtigkeit}{SOLL}
  \addrow{Test}{Wenn sich der Wind um 360 Grad dreht, ist auf der Anzeige und im Graphen kein Sprung erkennbar.}
\end{usecase}
% 
\begin{usecase}
...
\begin{usecase}
  ...
  \addrow{Wichtigkeit}{MUSS}
  \addrow{Test}{Die Eingabe von SQL-Befehlen führt höchstens zu einer Eingabe-Fehlermeldung. Es werden keine administrativen Daten der Datenbank angezeigt.}
\end{usecase}
%
\begin{usecase}
  ...
  \addrow{Wichtigkeit}{MUSS}
  \addrow{Test}{Der User versucht, eine unplausible Abfrage zu senden und erhält eine Fehlermeldung.}
\end{usecase}
%
\begin{usecase}
...
\begin{usecase}
  ...
  \addrow{Wichtigkeit}{KANN}
  \addrow{Test}{Der User ruft die Windgeschwindigkeit der letzen sieben Tage ab und exportiert die Daten in Excel.}
\end{usecase}
...
\begin{usecase}
  ...
  \addrow{Anforderung}{Die Wetterstation Arbon erhält einen geeigneten Pegel-Sensor, welcher mit den bereits verbauten Komponenten betrieben werden kann. Die Kosten für Anschaffung und Betrieb des neuen Sensors liegen innerhalb des Budgets der Wetterstation Arbon.}
  \addrow{Wichtigkeit}{MUSS}
...
\begin{usecase}
  ...
  \addrow{Anforderung}{Die Wetterstation Arbon verfügt über eine öffentlich nutzbare Schnittstelle (API) für Luft- und Wassertemperatur, sodass z.B. das Seebad diese übernehmen kann.}
  \addrow{Wichtigkeit}{MUSS}
  \addrow{Test}{Die Luft- und Wassertemperatur kann über ein API abgerufen werden und ist in JSON formatiert.}
\end{usecase}
%
\begin{usecase}
  \addheading{TD 030}{Sturmwarnung} 
  \addrow{Anforderung}{Auf der Webseite wird die aktuelle Sturmwarn-Situtation dargestellt. Falls es sich um eine eingebettete Seite handelt, muss diese https-fähig sein.}
  \addrow{Wichtigkeit}{SOLL}
...
\begin{usecase}
  ...
  \addrow{Anforderung}{Die Wetterstation Arbon erhält einen geeigneten Sonnenstrahlungs-Sensor. Die Kosten für Anschaffung und Betrieb des neuen Sensors liegen innerhalb des Budgets der Wetterstation Arbon.}
  \addrow{Wichtigkeit}{KANN}
...
%
\begin{usecase}
  \addheading{CA 020}{Sektorweise Zoombeschränkung} 
