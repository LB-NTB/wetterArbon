...
Die Tabelle wx data beinhaltet momentan 65 einzelne Attribute. Von der Stations ID bis zum Batterielevel der Station. Da die Datenbank nach der Bachelorarbeit vorallem für die API verwendet wird und es für den Benutzer uninteressant ist wie der Batteriestand ist, können diese Attribute herausgenommen werden. Stellt man die neuen Attribute, ohne auf sicht der neu Strukturierung zusammen würde dies für die wx data ein folgendes Bild ergeben /Diskussionspunkt{Foto neu wx data}
