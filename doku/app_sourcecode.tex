...
% Subscection
\includepdf[pages=-,frame,scale=0.7,pagecommand={\pagestyle{plain}\section{Bestätigungs-E-Mail des Amts für Informatik Thurgau}\label{anhang:email}}]{appendix/email.pdf}
